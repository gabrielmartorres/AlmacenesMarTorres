function cargarHuecosLibres(str) {
    var xmlhttp;
    if (str == "") {
        document.getElementById("numeroLibres").innerHTML = "";
        return;
    }
    ...
    xmlhttp.onreadystatechange = function() {
        if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
            document.getElementById("numeroLibres").innerHTML = xmlhttp.responseText;
            /*Seleccionamos el elemento que recibirá el flujo de datos*/
        }
    }
    xmlhttp.open("GET", "AjaxNumerosLibres.php?pasillosdisponibles="+str, true);
