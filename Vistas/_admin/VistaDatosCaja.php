            ...
            <div class="container tituloFormulario">
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <h2>Información de la caja a sacar</h2>
                    </div>
                </div>
            </div>
        </section>
                        ...
                        <table class="table table-sm table-dark">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">Estantería</th>
                                    <th scope="col">Nº de leja</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
                                foreach ($ArrayObj as $Object) {
                                    $fechaOriginal = $Object->FECHA_ALTA_CAJA;
                                    $nuevaFecha = date("d/m/Y", strtotime($fechaOriginal));
                                    $Codigocaja = $Object->CODIGO_CA;
                                    ?>
                                    <tr>
                                        <th name="codigoCaja" scope="row"><?= $Object->CODIGO_CA; ?></th>
                                        <td>
                                            <?= $Object->ALTURA; ?> x
                                            <?= $Object->ANCHURA; ?> x
                                            <?= $Object->PROFUNDIDAD; ?>
                                        ...
                                        <td><label class="colorCaja" style="background-color: <?= $Object->COLOR; ?>;"><label></td>
                                                    ...
                                                    <td><?= $nuevaFecha; ?></td>
                                                    <td><?= $Object->codigo_es; ?></td>
                                                    <td><?= $Object->leja_ocupada; ?></td>
                                                    <?php
                                                }
                                                ?>
                                                </tbody>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <form name="altaCaja" action="../../Controladores/ControladorSacarCaja.php" method="POST">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-4">
                                                                    <button type="button" style="float: right;" class="btn btn-danger mb-2" onClick="self.location.href = 'VistaBuscadorCaja.php?opcion=salida'">CANCELAR</button>
                                                                </div>
