...
class CajaBackup {
    ...
    private $fecha_salida_caja;
    
    function __construct($id_ca, $codigo_ca, $altura, $anchura, $profundidad, $color, $material_caja, $contenido, $fecha_alta_caja, $id_estanteria, $fecha_salida_caja) {
        ...
        $this->setFecha_salida_caja($fecha_salida_caja);
    }
    ...
    function getFecha_salida_caja() {
        return $this->fecha_salida_caja;
    }
    ...
    function setFecha_salida_caja($fecha_salida_caja) {
        $this->fecha_salida_caja = $fecha_salida_caja;
    }
    ...
    public function __toString() {
        return "Id: " .$this->id_ca.
               ...
               "Id de estantería " .$this->$id_estanteria.
               "Fecha de salida: " .$this->$fecha_salida_caja;
    }
